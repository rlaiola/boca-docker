...
- After building, set the user and image tags accordingly. The IMAGE_ID's will show up with the `docker image ls`;
  ...
  # docker tag IMAGE_ID_BOCA_BASE ghcr.io/rlaiola/boca-docker/boca-base:1.2.3
  docker tag IMAGE_ID_BOCA_WEB ghcr.io/rlaiola/boca-docker/boca-web:1.2.3
  docker tag IMAGE_ID_BOCA_JAIL ghcr.io/rlaiola/boca-docker/boca-jail:1.2.3
  ```
...
- Push the container images to repository.
  ...
  ```sh
  # boca-base only necessary for development
  # docker push ghcr.io/rlaiola/boca-docker/boca-base:1.2.3
  docker push ghcr.io/rlaiola/boca-docker/boca-web:1.2.3
  docker push ghcr.io/rlaiola/boca-docker/boca-jail:1.2.3
  ```
